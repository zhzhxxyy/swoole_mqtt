...
class Client
{
    ...
    public function __construct(string $host, int $port, $options = array())
    {
        ...
        $this->_connection =  new \Swoole\Async\Client(SWOOLE_SOCK_TCP);
     ...
     * onConnectionConnect
     */
    public function onConnectionConnect(\Swoole\Async\Client $client)
    {
        $package = array(
     ...
     * onConnectionReceive
     */
    public function onConnectionReceive( $client, $data)
    {
     ...
     * onConnectionError
     */
    public function onConnectionError(\Swoole\Async\Client $client)
    {
     ...
     * onConnectionClose
     */
    public function onConnectionClose(\Swoole\Async\Client $client)
    {
        if ($this->_options['debug']) {
